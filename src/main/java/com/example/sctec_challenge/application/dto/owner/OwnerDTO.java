...
@Schema(description = "Armazena dados completos do responsável pela empresa")
public record OwnerDTO(
        
        @Schema(description = "Identificador do responsável", example = "123e4567-e89b-12d3-a456-426614174000")
